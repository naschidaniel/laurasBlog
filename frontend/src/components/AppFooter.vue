<template>
  <footer class=" content-center border-t px-2 pt-2 pb-2 text-center w-full">
      <div class=" mx-auto flex flex-row justify-center">  
        <a :href="instagram" :id="instagram" class=" pl-2 pr-2"> 
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" class=" w-6 h-6 fill-current text-gray-700">
        ...
        <a :href="facebook" :id="facebook" class=" pl-2 pr-2">
