<template>
  <div
    class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mx-auto relative w-full lg:max-w-6xl"
    role="alert"
...
export default {
  name: "allerts",
  computed: mapGetters(["getNetworkError", "getNetworkErrorWindow"]),
  methods: {
    clickHandler(value) {
      console.log(value);
