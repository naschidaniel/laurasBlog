<template>
  <div>
    <div class="flex flex-wrap">
      <div v-for="bp in blogposts" :key="bp.title" class="w-full px-2 mt-3 md:w-1/2 lg:w-1/2 ">
        <div class="border border-lauraOrange rounded-lg shadow-md overflow-hidden">
          ...
          <div class="pt-3 py-2 px-2">
            <h3 class="text-xl text-lauraOrange">{{ bp.title }}</h3>
